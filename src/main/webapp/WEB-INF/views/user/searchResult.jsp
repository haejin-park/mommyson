            ...
            <div class="row" style="margin-bottom: 100px;">
            	<c:forEach items="${ requestScope.productList }" var="product">
            		<div class="col-3">
	                    ...
	                    <div class="menu_div">
	                        <a href="${ pageContext.servletContext.contextPath }/user/sidedish_detail?sdCode=${ product.sdCode }&memCode=${ product.memCode }" class="menu_name"><c:out value="${ product.sdName }"/>(<c:out value="${ product.volume }"/>g)</a>
	                        <pre><strong><fmt:formatNumber value="${ product.price - (product.price * product.discountRate / 100) }" /> 원</strong></pre>
