...
<body>
    ...
    <button type="button" id=customer><a href="customerJoin.html">사용자</a></button>
    &nbsp; &nbsp; 
    <button type="button" id=businessman><a href="businessJoin.html">사업자</a></button>
    &nbsp; &nbsp; 
    <button type="reset" id="goMoin"><a href="main.html">취소하기</a></button>
    <br><br><br><br><br><br>
