...
<body>
    ...
    <section>
      <form action="${ pageContext.servletContext.contextPath }/userMyPage/postReview" method="post" enctype="multipart/form-data">
            ...
            <div class="main_box">
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <hr>
                                    <input type="file" name="img" id="input-image">
                                </div>
                ...
                <div class="sub_box" style="margin-bottom: 100px; align-items: center; width: 36%;">
                    <div style="display: flex; justify-content: space-between; width: 100%;">
                        ...
                        <button class="pink_btn" type="submit">완료</button>
                    </div>
                </div>
            </div>
        </div>
