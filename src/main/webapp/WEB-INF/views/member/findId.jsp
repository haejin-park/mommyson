...
<link rel="stylesheet" type="text/css"
	href="${ pageContext.servletContext.contextPath }/resources/css/user/findId.css">
<link rel="stylesheet" type="text/css"
	href="${ pageContext.servletContext.contextPath }/resources/css/colorset.css">
</head>
<body>
	<div class="center">
		<br>
		...
		<form method="POST" onsubmit="return validate();">
			<input type="text" class="name" id="name" name="name"
				placeholder=" 이름을 입력해주세요" style="border-radius: 9px;"> <br>
			<br> <input type="email" class="email" id="email" name="email"
			...
			<button type="submit" class="btn btn-primary" data-toggle="modal"
				...
				style="width: 100px; height: 40px; border-radius: 9px; background-color: rgb(247, 170, 145); color: black; border: 2px solid black;">아이디찾기</button>
			&nbsp; &nbsp; &nbsp; &nbsp;
        ...
        /* 아이디 찾기 */
	    	...
	    	$.ajax({
	    		...
	    		success:function(data){
	    			console.log(data);
	    			$('#id').val(data);/* 서블릿에서 가져온 id 밸류에 넣기  */
	    		}, 
